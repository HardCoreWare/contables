...
class Bseg extends Table{
    ...
    public function index(){
        ...
        $sql =
        " SELECT BELNR AS numeroDocumento, KOSTL AS referencia, PSWSL AS moneda, BUKRS AS sociedadSap, CAST(DMBTR AS FLOAT64) AS importe, KOSTL AS ceco, BKTXT AS descripcion, HKONT AS cuenta,".
